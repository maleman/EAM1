...
public:
   ...
   IchimokuSignals   getKc(){ return kijunCrossSignal;}
   IchimokuSignals   getKB(){return kumoBreakSignal;}
   IchimokuSignals   getSc(){return senkouCrossSignal;}
   ...
   if(TekanKijunTrend!=NO_TREND && TekanKijunTrend!=ActualTekanKijunTrend)
     {
      ...
      if(ActualTekanKijunTrend==UPTREND && TekanKijunTrend==DOWNTREND)
        { //CRUZ ALCISTA
...
IchimukuSignal::kijunSenCross(double &Kijun[],double &Senkou_A[],double &Senkou_B[],MqlRates &rates[])
  {
   ...
   if(rates[ratesize].close>Senkou_A[senkou] && Kijun[kijun]>Senkou_A[senkou]
      && rates[ratesize].close>Senkou_B[senkou] && Kijun[kijun]>Senkou_B[senkou])
     {//KUMO OVER
...
IchimukuSignal::kumoBreak(double &Senkou_A[],double &Senkou_B[],MqlRates &rates[])
  {
   ...
   if((rates[rateSize-2].open<Senkou_A[senkou-2] && rates[rateSize-2].open>Senkou_B[senkou-2])
      || (rates[rateSize-2].open>Senkou_A[senkou-2] && rates[rateSize-2].open<Senkou_B[senkou-2]))
     { //IF 3 LAST BARS EXISTS OPEN PRICE INSIDE OF KUMO
